...
export default function App() {
  ...
  // Detect if input looks like a person's name (2 words, no known retailer keywords)
  const detectSearchMode = (val) => {
    ...
    // If 2 words, no numbers, no company keywords — treat as person name
    if (words.length >= 2 && words.length <= 4 && !isCompany && !/\d/.test(trimmed)) {
      return "person";
    }
    return "company";
  };
