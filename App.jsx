...
const SUBCATEGORY_MAP = {
  ...
  "Beverages – Alcohol":["Food & Beverage"],
  ...
  "Seasonal & Holiday Décor":["Home & Garden","Household Goods"],
          ...
          {leads.length === 0 ? (
            ...
            <>
              <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap",marginBottom:4}}>
                <div className="result-badge">✓ {leads.length} buyer{leads.length!==1?"s":""} found — "{searchQuery}"</div>
                        ...
                        <div className="contact-row">
                          ...
                          {isSubscribed ? (
                            <>
                              ...
                              <button className={`copy-btn ${copiedField===lead.id+"email"?"copied":""}`} onClick={()=>copyField(lead.email, lead.id+"email")}>{copiedField===lead.id+"email"?"✓":"Copy"}</button>
                            </>
                          ) : (
                        ...
                        <div className="contact-row">
                          ...
                          {isSubscribed ? (
                            <>
                              ...
                              <button className={`copy-btn ${copiedField===lead.id+"phone"?"copied":""}`} onClick={()=>copyField(lead.phone, lead.id+"phone")}>{copiedField===lead.id+"phone"?"✓":"Copy"}</button>
                            </>
                          ) : (
                            <span className="contact-value" style={{display:"flex",alignItems:"center",gap:6}}>
