export default async function handler(req, res) {
  ...
  const BUYER_WORDS = ["buyer", "merchant", "purchas", "category", "merchandis", "dmm", "divisional", "procurement", "sourcing", "merchandise manager", "product manager", "inventory", "head of buying", "chief merchant", "vp of", "director of"];
  ...
  const CATEGORY_RULES = {
    "Food & Beverage": {
      ...
      searchTitles: ["food buyer", "grocery buyer", "beverage buyer", "frozen buyer", "snack buyer", "deli buyer", "center store buyer", "food merchant", "grocery merchant"],
    },
    "Health & Beauty": {
      ...
      searchTitles: ["health buyer", "beauty buyer", "personal care buyer", "wellness buyer", "OTC buyer", "skincare buyer", "health merchant"],
    },
    "Household & Cleaning": {
    ...
    "Home & Garden": {
      ...
      searchTitles: ["home buyer", "garden buyer", "lawn buyer", "outdoor buyer", "furniture buyer", "seasonal buyer", "appliance buyer", "home merchant"],
    },
    "Electronics": {
    ...
    "Toys & Games": {
      ...
      exclude: ["food", "beverage", "grocery", "pet", "footwear", "shoe", "apparel", "vitamin", "beauty", "electronics", "automotive", "sporting", "garden", "hardware", "office"],
    ...
    "Apparel & Footwear": {
      ...
      searchTitles: ["apparel buyer", "clothing buyer", "footwear buyer", "fashion buyer", "softlines buyer", "apparel merchant"],
    },
    "Sporting Goods & Outdoors": {
      include: ["sporting", "sport", "fitness", "athletic", "recreation", "outdoor", "camping", "hunting", "fishing", "exercise", "gym"],
      exclude: ["food", "beverage", "grocery", "pet", "footwear", "shoe", "apparel", "clothing", "baby", "toy", "vitamin", "beauty", "cosmetic", "automotive", "jewelry", "office"],
      searchTitles: ["sporting goods buyer", "fitness buyer", "outdoor buyer", "recreation buyer", "athletic buyer", "sporting merchant"],
    },
    "Automotive": {
    ...
    "Pet": {
      ...
      searchTitles: ["pet buyer", "pet food buyer", "animal care buyer", "pet supplies buyer", "pet merchant"],
    },
    "Baby & Kids": {
    ...
    "Grocery & Gourmet": {
      ...
      searchTitles: ["grocery buyer", "gourmet buyer", "specialty food buyer", "natural food buyer", "grocery merchant"],
    },
    "Tools & Hardware": {
      ...
      searchTitles: ["tools buyer", "hardware buyer", "power tools buyer", "equipment buyer", "outdoor power buyer", "hardware merchant"],
    },
  };

  const rules = category ? CATEGORY_RULES[category] : null;

  // When no category — search broadly for ANY buying role at the company
  const personTitles = rules?.searchTitles || [
    ...
    "VP merchandising", "sourcing manager", "merchandise manager",
    "head of buying", "chief merchant", "procurement manager",
    "product manager merchandising", "inventory buyer"
  ];
  ...
  const aliases = {
    ...
    "tractor supply": ["Tractor Supply", "Tractor Supply Co", "Tractor Supply Company", "TSC"],
  };
  ...
  const retailerTypeMap = {
    ...
    specialty:        ["Northern Tool", "Tractor Supply Co", "Harbor Freight", "Ace Hardware"],
  ...
  try {
    // Fetch multiple pages to get more contacts
    ...
    // Deduplicate by full name + company
    const seen = new Set();
    const people = [...page1, ...page2, ...page3].filter(p => {
      const key = `${p.first_name}${p.last_name}${p.organization_name}`.toLowerCase();
    ...
    const filtered = people.filter(p => {
      ...
      // No category = return all buyer types
