...
const ALL_LEADS = [
  // ── WALMART ──────────────────────────────────
  { id:"w1",  firstName:"Greg",      lastName:"Fontaine",      title:"Category Manager – Baby & Infant",          retailer:"Walmart",                 retailerType:"bigbox",     email:"g.fontaine@walmart.com",              phone:"(479) 204-1837", location:"Bentonville, AR",  categories:["Baby & Kids"],                          confidence:89, context:"Managing baby care reset Q3 2025. Evaluating new diaper & wipe entrants on price/sustainability." },
  ...
  { id:"w3",  firstName:"DeShawn",   lastName:"Morris",         title:"Merchant – Household Cleaning",             retailer:"Walmart",                 retailerType:"bigbox",     email:"d.morris@walmart.com",                phone:"(479) 277-5190", location:"Bentonville, AR",  categories:["Cleaning Products"],                    confidence:87, context:"Expanding eco-friendly cleaning shelf. Brands must scale to 4,600+ doors." },
  { id:"w4",  firstName:"Carrie",    lastName:"Zhang",          title:"DMM – Health & Wellness",                   retailer:"Walmart",                 retailerType:"bigbox",     email:"c.zhang@walmart.com",                 phone:"(479) 204-6631", location:"Bentonville, AR",  categories:["Supplements & Vitamins"],               confidence:90, context:"Overseeing supplement reset. Focused on value-priced everyday wellness SKUs." },
  // ── TARGET ───────────────────────────────────
  { id:"t1",  firstName:"Marcus",    lastName:"Tillman",        title:"Category Manager – Home Care",              retailer:"Target",                  retailerType:"bigbox",     email:"m.tillman@target.com",                phone:"(612) 304-7714", location:"Minneapolis, MN",  categories:["Household Goods","Cleaning Products"],  confidence:91, context:"Sourcing sustainable/eco brands for 2025 reset." },
  ...
  { id:"t3",  firstName:"Joel",      lastName:"Strickland",     title:"Merchant – Food & Beverage",                retailer:"Target",                  retailerType:"bigbox",     email:"j.strickland@target.com",             phone:"(612) 304-2255", location:"Minneapolis, MN",  categories:["Food & Beverage","Snacks & Confection"],confidence:88, context:"Big push on better-for-you snacking and functional beverages." },
  ...
  { id:"k2",  firstName:"Brian",     lastName:"Kowalski",       title:"Category Manager – Frozen Foods",           retailer:"Kroger",                  retailerType:"grocery",    email:"b.kowalski@kroger.com",               phone:"(513) 762-1133", location:"Cincinnati, OH",   categories:["Frozen & Refrigerated"],                confidence:90, context:"Overseeing frozen reset. Seeking plant-based and globally-inspired SKUs." },
  { id:"k3",  firstName:"Yolanda",   lastName:"Pierce",         title:"DMM – Natural & Organic",                   retailer:"Kroger",                  retailerType:"grocery",    email:"y.pierce@kroger.com",                 phone:"(513) 762-8827", location:"Cincinnati, OH",   categories:["Natural / Organic"],                    confidence:88, context:"Leads Simple Truth private label + natural brand procurement. $1B+ division." },
  ...
  // ── ALBERTSONS ───────────────────────────────
  { id:"a1",  firstName:"Rachel",    lastName:"Osei",           title:"DMM – Health, Beauty & Personal Care",      retailer:"Albertsons",              retailerType:"grocery",    email:"r.osei@albertsons.com",               phone:"(208) 395-6200", location:"Boise, ID",        categories:["Health & Beauty"],                      confidence:88, context:"Manages $400M HBC division. Prioritizing indie brands with strong DTC proof." },
  ...
  // ── CVS ──────────────────────────────────────
  { id:"cvs1",firstName:"Monica",    lastName:"Hartley",        title:"Category Manager – Vitamins & Supplements", retailer:"CVS Health",              retailerType:"drugstore",  email:"m.hartley@cvs.com",                   phone:"(401) 765-3300", location:"Woonsocket, RI",   categories:["Supplements & Vitamins"],               confidence:93, context:"Vitamin reset for 2025. Looking for functional wellness brands for end-caps." },
  ...
  // ── SPROUTS ──────────────────────────────────
  { id:"sp1", firstName:"Ingrid",    lastName:"Caldwell",       title:"Category Manager – Vitamins & Supplements", retailer:"Sprouts Farmers Market",  retailerType:"natural",    email:"i.caldwell@sprouts.com",              phone:"(480) 814-8016", location:"Phoenix, AZ",      categories:["Supplements & Vitamins"],               confidence:90, context:"New supplement innovation set launch. Receptive to emerging brands with clinical backing." },
  ...
  // ── PETCO ────────────────────────────────────
  { id:"pc1", firstName:"Andre",     lastName:"Voss",           title:"Category Manager – Supplements & Wellness", retailer:"Petco",                   retailerType:"pet",        email:"a.voss@petco.com",                    phone:"(858) 740-0123", location:"San Diego, CA",    categories:["Pet Products"],                         confidence:90, context:"Vetco wellness expansion. Vet-recommended supplement brands for dogs & cats." },
  // ── CHEWY ────────────────────────────────────
  ...
  // ── HOME DEPOT ───────────────────────────────
  { id:"hd1", firstName:"Clint",     lastName:"Abernathy",      title:"Merchant – Cleaning & Chemicals",           retailer:"Home Depot",              retailerType:"home",       email:"c.abernathy@homedepot.com",           phone:"(770) 433-8211", location:"Atlanta, GA",      categories:["Cleaning Products","Household Goods"],  confidence:86, context:"Managing cleaning and surface care reset. Open to eco-certified alternatives." },
  { id:"hd2", firstName:"Sandra",    lastName:"Chow",           title:"Category Manager – Outdoor & Garden",       retailer:"Home Depot",              retailerType:"home",       email:"s.chow@homedepot.com",                phone:"(770) 433-5577", location:"Atlanta, GA",      categories:["Home & Garden"],                        confidence:83, context:"Seasonal garden reset underway. Seeking new soil, fertilizer, and pest control entrants." },
  // ── LOWE'S ───────────────────────────────────
  ...
  // ── GNC ──────────────────────────────────────
  { id:"gn1", firstName:"Paul",      lastName:"Ferretti",       title:"Category Manager – Sports Nutrition",       retailer:"GNC",                     retailerType:"specialty",  email:"p.ferretti@gnc.com",                  phone:"(412) 288-4600", location:"Pittsburgh, PA",   categories:["Supplements & Vitamins","Sporting Goods"],confidence:88, context:"Rebuilding sports nutrition set post-restructure. Very interested in clean-label protein and pre-workout brands." },
  // ── BEST BUY ─────────────────────────────────
  { id:"bb1", firstName:"Neil",      lastName:"Okonkwo",        title:"Category Manager – Smart Home & IoT",       retailer:"Best Buy",                retailerType:"electronics",email:"n.okonkwo@bestbuy.com",               phone:"(612) 291-1000", location:"Richfield, MN",    categories:["Electronics & Tech"],                   confidence:86, context:"Expanding smart home ecosystem. Looking for connected devices with strong app integration." },
  // ── ALDI ─────────────────────────────────────
  { id:"al1", firstName:"Megan",     lastName:"Schultz",        title:"Category Manager – Chilled & Fresh",        retailer:"ALDI",                    retailerType:"grocery",    email:"m.schultz@aldi.us",                   phone:"(630) 879-8100", location:"Batavia, IL",      categories:["Food & Beverage","Frozen & Refrigerated"],confidence:87, context:"ALDI's private label model is core but they source branded specialty items for ALDI Finds events." },
  // ── H-E-B ────────────────────────────────────
  ...
  // ── 7-ELEVEN ─────────────────────────────────
  { id:"7e1", firstName:"Michelle",  lastName:"Park",           title:"Category Manager – Better-For-You Snacks",  retailer:"7-Eleven",                retailerType:"convenience",email:"m.park@7-eleven.com",                 phone:"(972) 828-7011", location:"Irving, TX",       categories:["Snacks & Confection","Food & Beverage"],confidence:85, context:"Building a healthier snack assortment for convenience. 100+ units/store/week threshold required." },
  // ── AUTOZONE ─────────────────────────────────
  { id:"az1", firstName:"Patrick",   lastName:"Dunne",          title:"Category Manager – Car Care",               retailer:"AutoZone",                retailerType:"auto",       email:"p.dunne@autozone.com",                phone:"(901) 495-6500", location:"Memphis, TN",      categories:["Automotive"],                           confidence:83, context:"Managing car care accessories, cleaners, and interior accessories. Seeking premium entrants." },
  // ── MICHAELS ─────────────────────────────────
  ...
  // ── UNFI ─────────────────────────────────────
  { id:"un1", firstName:"Scott",     lastName:"Baxter",         title:"Category Manager – Grocery",                retailer:"UNFI",                    retailerType:"wholesale",  email:"s.baxter@unfi.com",                   phone:"(401) 528-8634", location:"Providence, RI",   categories:["Natural / Organic","Food & Beverage"],  confidence:88, context:"UNFI distributes to 30,000+ retail doors. Getting on UNFI opens Whole Foods, Sprouts, and independents." },
  // ── KEHE ─────────────────────────────────────
...
function searchLeads({ retailerName, selectedRetailerTypes, productCategory }) {
  ...
  // Category never excludes — it just sorts matched buyers to the top
  if (productCategory) {
